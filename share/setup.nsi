...
!define URL http://bitgem.rocks

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/bitgem.ico"
...
OutFile BitGem-win32-setup.exe
...
VIAddVersionKey ProductName BitGem
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    File ../release/bitgem-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/bitgemd.exe
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Uninstall BitGem.lnk"
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\BitGem.lnk"
    Delete /REBOOTOK "$SMSTARTUP\BitGem.lnk"
